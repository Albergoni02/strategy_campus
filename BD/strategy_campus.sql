...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/11/2024 às 21:41
...
(27, NULL, 'Saguão', '2024-10-10', '22:34:33', 'avancado', 8, 'tabuleiro', 'Damas', 8, 6),
(28, NULL, 'Auditório', '2024-11-14', '21:13:34', 'intermediario', 1, 'tabuleiro', 'Xadrez', 7, 8);
...
--
ALTER TABLE `partida`
  MODIFY `idPartida` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
